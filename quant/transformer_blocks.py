...
from .attn import INTBasicTransformerBlock
...
class INTTransFormer2DModel(Transformer2DModel):
    ...
    def from_float(module: Transformer2DModel) -> INTTransFormer2DModel:
        ...
        module.proj_in = W8A8B8O8Conv2D16.from_float(module.proj_in, 1., 1.)
        module.transformer_blocks = torch.nn.ModuleList(
            [INTBasicTransformerBlock.from_float(cast(BasicTransformerBlock, block)) 
                                     for block in module.transformer_blocks])
        module.proj_out = W8A8B8O8Conv2D16.from_float(module.proj_out, 1., 1.)

        module.__class__ = INTTransFormer2DModel
        module = cast(INTTransFormer2DModel,  module)
        return module
...
class INTCrossAttnDownBlock2D(CrossAttnDownBlock2D):
    ...
    @staticmethod
    def from_float(module: CrossAttnDownBlock2D) -> INTCrossAttnDownBlock2D:
        module.attentions = torch.nn.ModuleList([
            INTTransFormer2DModel.from_float(block) for block in module.attentions
        ])

        module.resnets = torch.nn.ModuleList([
            INTResnetBlock2D.from_float(block) for block in module.resnets
        ])

        module.downsamplers = torch.nn.ModuleList([
            INTDownSample2D.from_float(block) for block in module.downsamplers
        ])
        
        module.__class__ = INTCrossAttnDownBlock2D
        module = cast(INTCrossAttnDownBlock2D,  module)
        return module
    

class INTDownBlock2D(DownBlock2D):
    @staticmethod
    def from_float(module: DownBlock2D) -> INTDownBlock2D:
        ...
        module.__class__ = INTDownBlock2D
        module = cast(INTDownBlock2D,  module)
        return module
...
class INTUpBlock2D(UpBlock2D):
    @staticmethod
    def from_float(module: UpBlock2D) -> INTUpBlock2D:
        module.resnets = torch.nn.ModuleList([
            INTResnetBlock2D.from_float(block) for block in module.resnets
        ])

        if module.upsamplers is not None:
            module.upsamplers = torch.nn.ModuleList([
                INTUpsample2D.from_float(block) for block in module.upsamplers
            ])

        module.__class__ = INTUpBlock2D
        module = cast(INTUpBlock2D,  module)
        return module
    

class INTCrossAttnUpBlock2D(CrossAttnUpBlock2D):

    @staticmethod
    def from_float(module: CrossAttnUpBlock2D) -> INTCrossAttnUpBlock2D:
        module.attentions = torch.nn.ModuleList([
            INTTransFormer2DModel.from_float(block) for block in module.attentions
        ])
        ...
        module.__class__ = INTCrossAttnUpBlock2D
        module = cast(INTCrossAttnUpBlock2D,  module)
        return module
    

class INTUNetMidBlock2DCrossAttn(UNetMidBlock2DCrossAttn):
    @staticmethod
    def from_float(module: UNetMidBlock2DCrossAttn):
...
class INTUNet2DConditionModel(UNet2DConditionModel):
    def forward(
        self,
    ...
    def from_float(module: UNet2DConditionModel) -> INTUNet2DConditionModel:
        ...
        module.down_blocks = torch.nn.ModuleList([
            ...
            INTCrossAttnDownBlock2D.from_float(module.down_blocks[2]),
            INTDownBlock2D.from_float(module.down_blocks[3]),
        ])

        module.up_blocks = torch.nn.ModuleList([
            INTUpBlock2D.from_float(module.up_blocks[0]),
            INTCrossAttnUpBlock2D.from_float(module.up_blocks[1]),
            INTCrossAttnUpBlock2D.from_float(module.up_blocks[2]),
            INTCrossAttnUpBlock2D.from_float(module.up_blocks[3]),
        ])

        module.mid_block = INTUNetMidBlock2DCrossAttn.from_float(module.mid_block)

        module.__class__ = INTUNet2DConditionModel
        module = cast(INTUNet2DConditionModel,  module)
        return module